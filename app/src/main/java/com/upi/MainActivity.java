...
public class MainActivity extends AppCompatActivity {
    ...
    String payeeAddress = "9827445708@upi";
    String payeeName = "Dilip Singh Panwar";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //txnId=null&responseCode=&ApprovalRefNo=null&Status=FAILURE&txnRef=undefined
        if (data != null) {
            Log.e(TAG, "onActivityResult: data: " + data.getStringExtra("response"));
